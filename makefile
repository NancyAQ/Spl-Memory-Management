...
bin/cRace: bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/EdgeSelectionPolicy.o bin/MandatesSelectionPolicy.o bin/MandatesJoinPolicy.o bin/LastOfferJoinPolicy.o
	g++ -o bin/cRace bin/main.o bin/Agent.o bin/Graph.o bin/Parser.o bin/Party.o bin/Simulation.o bin/EdgeSelectionPolicy.o bin/MandatesSelectionPolicy.o bin/MandatesJoinPolicy.o bin/LastOfferJoinPolicy.o
...
bin/EdgeSelectionPolicy.o:src/EdgeSelectionPolicy.cpp
	g++ -g -Wall -Weffc++ -std=c++11 -c -Iinclude -o bin/EdgeSelectionPolicy.o src/EdgeSelectionPolicy.cpp
